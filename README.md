...
> 新增独立的[朋友语音频道](docs/voice-community.md)：用户名与密码注册、三个最多 6 人的点对点语音房间，以及可定制昵称、头像、简介和配色的个人面板。入口位于主站导航栏；Azure 备用站保持不变。不开启录音或转写，不使用 Azure 语音中继；受网络条件影响，点对点连接不保证所有移动网络均可互通。
